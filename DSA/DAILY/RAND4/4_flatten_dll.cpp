    ...
    Node *flatten(Node *head)
    {
        ...
        while (ptr)
        {
            if (ptr->child)
            {
                ...
                tmp_next = ptr->next;   // cur-next node
                ptr->next = ptr->child; // attaching cur nxt to child
                ptr->next->prev = ptr;  // attaching child prev to curr
                ptr->child = NULL;
                ...
                runner->next = tmp_next; // attaching child-end nxt to next-cur node
                if (runner->next)
                    runner->next->prev = runner; // attaching cur-next node prev to chid-end
            }
...
int main()
{
    // Creating the linked list with child nodes
