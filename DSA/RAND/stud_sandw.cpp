...
public:
    int countStudents(vector<int> &students, vector<int> &sandwiches)
    {
        ...
        while (!studentQueue.empty())
        {
            ...
            {
                // If the top sandwich doesn't match the front student's preference,
                // we rotate the student to the end of the queue
...
int main()
{
    ...
    Solution sol;
    int remainingStudents = sol.countStudents(students, sandwiches);

    cout << "Remaining students: " << remainingStudents << endl;

    return 0;
}

// class Solution {
//     public int countStudents(int[] s, int[]s1) {
//        int a0=0,a1=0;
